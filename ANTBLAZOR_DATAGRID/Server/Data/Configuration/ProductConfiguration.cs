...
namespace ANTBLAZOR_DATAGRID.Server.Data.Configuration
{
        ...
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            ...
            (
                ...
                new Product
                {
                    ...
                    Price = 11,
                    ManufactureDate = new DateTime(2020, 7, 13)
                },
                new Product
                {
                    ...
                    Price = 22,
                    ManufactureDate = new DateTime(2016, 11, 23)
                },
                //Clothing
                new Product
                {
                    ...
                    Price = 20,
                    ManufactureDate = new DateTime(2020, 3, 11)
                },
                new Product
                {
                    ...
                    Price = 30,
                    ManufactureDate = new DateTime(2015, 9, 13)
                },
                new Product
                {
                    ...
                    Price = 40,
                    ManufactureDate = new DateTime(2021, 1, 16)
                },
                new Product
                {
                    ...
                    Price = 55,
                    ManufactureDate = new DateTime(2013, 2, 22)
                },
                //Phone
                new Product
                {
                ...
                new Product
                {
                    ...
                    Price = 35,
                    ManufactureDate = new DateTime(2019, 12, 1)
                },
                new Product
                {
                    ...
                    Price = 45,
                    ManufactureDate = new DateTime(2020, 2, 22)
                },
                //Home
                new Product
                {
